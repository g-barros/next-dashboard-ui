...
export default function TeacherForm(
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<TeacherSchema>({ resolver: zodResolver(teacherSchema) });
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <CldUploadWidget uploadPreset="lamaSchool" onSuccess={(result, {widget}) => {
          setImg(result.info);
          widget.close();
        }}>
          {({ open }) => {
